...
from computer_use_agent.paths import SANDBOX, resolve_sandbox_subdir
from computer_use_agent.schemas import Goal, MemoryItem
from computer_use_agent.search_providers import heuristic_tool_call
...
def test_catalog_stats_pdf_alias(tmp_path, monkeypatch):
    from computer_use_agent import catalog, indexing, paths
    from computer_use_agent.catalog import IndexedDocumentRecord, _index_record_for_path
...
def test_enrich_index_document_keeps_pdf_path_with_sidecar(tmp_path, monkeypatch):
    from computer_use_agent import indexing, paths
    from computer_use_agent.schemas import Goal, ToolCall
    from computer_use_agent.search_providers import enrich_tool_call

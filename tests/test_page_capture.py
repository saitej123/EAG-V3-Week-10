...
from computer_use_agent.browser.page_capture import PageCapture, resolve_screenshot_path
from computer_use_agent.browser.replay import format_replay_sections


def test_resolve_screenshot_path_rejects_traversal(tmp_path, monkeypatch):
    from computer_use_agent import persistence

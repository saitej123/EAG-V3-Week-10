...
from computer_use_agent.comparison_format import (
...
def test_comparison_pricing_gemini_query_codeium_windsurf():
    from computer_use_agent.comparison_format import comparison_pricing_gemini_query
...
def test_parse_pricing_facts_structured():
    from computer_use_agent.comparison_format import _parse_pricing_facts
...
def test_enrich_distiller_fills_codeium_gap(monkeypatch):
    from computer_use_agent.comparison_format import enrich_distiller_pricing_gaps

    monkeypatch.setattr(
        "computer_use_agent.pricing_enrich.fetch_all_products",
        lambda products: {
            p: (
                {
...
def test_parse_comparison_table_from_vlm_markdown():
    from computer_use_agent.comparison_format import _parse_comparison_table_from_text
...
def test_enrich_browser_comparison_from_markdown():
    from computer_use_agent.comparison_format import enrich_browser_comparison_gaps

...
from computer_use_agent.browser.turn_rules import fence_actions, is_dropdown_trigger, normalize_actions
from computer_use_agent.browser.extract import content_is_useful, goal_keywords
from computer_use_agent.vision_api import decode_image_payload
...
def test_annotate_marks_returns_png():
    ...
    from computer_use_agent.browser.drivers.elements import Element
    from computer_use_agent.browser.drivers.marks import annotate
...
def test_detect_gateway_block():
    from computer_use_agent.browser.gateway import detect_gateway_block
...
def test_layer_extract_escalates_on_captcha_html(monkeypatch):
    ...
    from computer_use_agent.browser import extract as extract_mod
...
def test_browser_output_shape():
    from computer_use_agent.browser.skill import to_browser_output
...
def test_cost_fields_default_zero():
    from computer_use_agent.browser.ledger import apply_cost_fields, estimate_cost_usd
...
def test_browser_replay_payload():
    from computer_use_agent.browser.replay import browser_replay_payload
...
def test_force_path_runs_single_layer(monkeypatch):
    ...
    monkeypatch.setattr("computer_use_agent.browser.drivers.cascade.BrowserSkill.run", fake_run)

    async def _run() -> None:
        from computer_use_agent.browser.skill import run_browser_cascade
...
def test_reference_sessions_match_corpus(browser_reference_sessions):
    ...
    from computer_use_agent.catalog import load_assignment_spec
...
def test_action_count_includes_vision_turns():
    from computer_use_agent.browser.validation import action_count
...
def test_github_trending_content_formats_required_rows():
    from computer_use_agent.browser.drivers.cascade import _github_trending_content
    from computer_use_agent.comparison_format import format_comparison_answer
...
def test_hf_models_content_formats_required_rows():
    from computer_use_agent.browser.drivers.cascade import _hf_models_content
    from computer_use_agent.comparison_format import format_comparison_answer
...
def test_urbanpro_training_content_formats_provider_rows():
    from computer_use_agent.browser.drivers.cascade import _urbanpro_training_content
    from computer_use_agent.comparison_format import format_comparison_answer
...
def test_amazon_product_content_formats_required_fields():
    ...
    from computer_use_agent.browser.drivers.cascade import _amazon_product_content
...
def test_resolve_cnc_bangalore_uses_live_urbanpro_category():
    from computer_use_agent.browser.urls import resolve_browser_urls
...
def test_comparison_content_ready_rejects_homepage_blob():
    from computer_use_agent.browser.validation import comparison_content_ready
...
def test_layer_succeeded_rejects_homepage_despite_actions():
    from computer_use_agent.browser.validation import layer_succeeded
...
def test_format_browser_path_labels():
    from computer_use_agent.browser.replay import format_browser_path

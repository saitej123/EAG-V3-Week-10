...
from computer_use_agent.vision_api import (
...
def test_vision_analyze_retries_on_empty_text(monkeypatch):
    ...
    with patch("computer_use_agent.vision_api.shared_gemini_client", return_value=client):
        with patch("computer_use_agent.vision_api.gemini_vision_models_ordered", return_value=["bad-model", "good-model"]):
